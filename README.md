...
**Live site:** https://waikinli98.github.io/

Single static page (`index.html`) — no build step, no framework. Interactive maps via Leaflet + CARTO basemaps.
See [EDITING-GUIDE.md](EDITING-GUIDE.md) for how to make changes.
